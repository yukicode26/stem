        ...
        <nav className="w-auto">
          <div className="p-0 navbar lg:mt-4">
            ...
            <div className="ml-auto dropdown lg:hidden">
              <label tabIndex={0} className="btn btn-ghost bg-transparent shadow-none border-transparent" aria-label="Open menu">
                <svg
            ...
            <ul className="hidden px-1 text-lg menu menu-horizontal lg:flex">
              <li>
                <Link href="/" className="hover:bg-transparent hover:scale-105">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="hover:bg-transparent hover:scale-105">
                  About
                </Link>
              </li>
              <li>
                <Link href="/shop" className="hover:bg-transparent hover:scale-105">
                  Shop
                </Link>
              </li>
              <li>
                <Link href="/journal" className="hover:bg-transparent hover:scale-105">
                  Journal
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:bg-transparent hover:scale-105">
                  Contact
                </Link>
              </li>
              <li>
                <Link
                  href="/shop/cart"
                  className="flex items-center gap-2 hover:bg-transparent hover:scale-105"
              ...
              <li>
                {/* daisyUI dark mode */}
                <label className="swap swap-rotate bg-transparent hover:scale-105">
                  <input 
                  type="checkbox" 
                  checked={isDark} 
