  ...
  return (
    <section className="mx-auto grid min-h-[80vh] max-w-7xl items-center gap-14 px-8 py-10 md:px-16 lg:grid-cols-2">
      ...
      <div className="max-w-xl">
        ...
        <h1 className="text-5xl leading-[1.05] text-sub md:text-7xl">
          Quiet flowers
          <br />
          for beautiful
          <br />
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Link
            href="/shop"
            className="px-8 py-4 text-sm uppercase tracking-[0.2em] transition hover:bg-accent hover:text-primary"
          >
            Shop Now
          </Link>
          ...
          <Link
            href="/about"
            className="border border-secondary-light px-8 py-4 text-sm uppercase tracking-[0.2em] text-sub transition hover:bg-accent-light"
          >
            Our Story
          </Link>
        </div>
